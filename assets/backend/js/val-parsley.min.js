...
!function ($) {
  ...
  */
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
        defaultMessage: "Verifique este valor."
      , type: {
            email:      "Ingrese un email válido."
          , url:        "Ingrese una URL válida."
          , urlstrict:  "Ingrese una URL válida."
          , telef:     "Ingrese un teléfono válido."
          , number:     "Ingrese un número válido."
          , digits:     "Ingrese solo dígitos."
          , letters:    "Ingrese solo letras."
          , dateIso:    "Ingrese una fecha válida (AAAA-MM-DD)."
          , dateEsp:    "Ingrese una fecha válida (DD/MM/AAAA)."
          , any: 		"Ingrese solo letras y números."
          , alphanum:   "Ingrese solo letras y números."
          , alphanumbs:	"Ingrese solo letras, números y '/\'"
          , standar:	"Ingrese caracteres válidos"
          , address:    "Ingrese solo letras y números."
          , phone:      "Ingrese un teléfono válido."
        }
      , notnull:        "Este campo no puede estar vacío."
      ...
      , length:         "Este valor debe ser de %s caracteres."
      , range:          "Este valor debe estar entre %s y %s."
      , minlength:      "Este valor debe tener %s caracteres o mas."
      , maxlength:      "Este valor debe tener %s caracteres o menos."
      , rangelength:    "Este valor es de %s a %s carateres."
      , mincheck:       "Debe elegir al menos %s opciones."
      , maxcheck:       "Debe elegir %s opciones o menos."
          ...
          validate: function ( val, type ) {
            ...
            switch ( type ) {
              ...
              case 'dateIso':
                ...
                break;
              case 'dateEsp':
                regExp = /^(0[1-9]|1[012])[ \/.](0[1-9]|[12][0-9]|3[01])[ \/.](20)\d\d$/;
                break;
              case 'phone':
  ...
  */
  $.fn.parsley.defaults = {
    ...
    namespace: 'val-'                       // DOM-API, default 'parsley-'. W3C valid would be 'data-parsley-' but quite ugly
    , inputs: 'input, textarea, select'         // Default supported inputs.
    , excluded: 'input[type=hidden]' // Do not validate input[type=hidden] & :disabled.
