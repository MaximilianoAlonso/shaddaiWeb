...
class servicios_subimagenes {
	private $db;

	public function tabla($id_servicios = 0, $id_imagenes = 0, $requestData, $web){
		global $db, $sesion;
		try{
			$sql = " SELECT
			c.*
			FROM
			servicios_subimagenes c
			WHERE
			c.id_servicios = '".$id_servicios."' 
			AND
			...
			while($row = $q->fetchObject()) {
				...
				$dir = _HOSTDIR_."/uploads/servicios/imagenes/adicionales/big/".$row->photo_subimagenes;
				$dir2 = _HOSTDIR_."/uploads/servicios/imagenes/adicionales/small/".$row->photo_subimagenes;
				if (file_exists($dir) && file_exists($dir2) && $row->photo_subimagenes != "") {
					$nestedData[] = '<img src="'._HOST_.'/uploads/servicios/imagenes/adicionales/small/'.$row->photo_subimagenes.'" alt="'.$row->photo_subimagenes.'" style="max-width: 150px;" >';
				}else{
	...
	public function edit($id_subimagenes){
		global $db, $sesion;
		try{
			$sql= "SELECT * FROM servicios_subimagenes WHERE id_subimagenes=:id_subimagenes AND eliminado_subimagenes = 0 ";
			$sql = $db->prepare($sql);
			...
			if($sql->rowCount() > 0){
				while($row = $sql->fetchObject()) {
					...
					$dir2 = _HOSTDIR_."/uploads/servicios/imagenes/adicionales/small/".$row->photo_subimagenes;
					if (file_exists($dir) && file_exists($dir2) && $row->photo_subimagenes != "") {
						$this->photo_subimagenes=_HOST_."/uploads/servicios/imagenes/adicionales/small/".$row->photo_subimagenes;
					}else{
	...
	public function data($id_servicios = 0, $id_imagenes = 0, $random = null, $limit = 0){
		global $db, $sesion;
		try{
			$data = array();
			$sql = "SELECT * FROM servicios_subimagenes WHERE active_subimagenes = '1' AND eliminado_subimagenes = 0 ";
			if ($id_servicios > 0) {
			...
			if($sql->rowCount() > 0){
				while($row = $sql->fetchObject()) {
					...
					if (file_exists($dir)  && $row->photo_subimagenes != "") {
						$json['photo'] =_HOST_."/uploads/servicios/imagenes/adicionales/big/".$row->photo_subimagenes;
					}else{
					...
					if (file_exists($dir2)  && $row->photo_subimagenes != "") {
						$json['photo_small'] =_HOST_."/uploads/servicios/imagenes/adicionales/small/".$row->photo_subimagenes;
					}else{
	...
	public function listado($id_servicios = 0, $id_imagenes = 0, $pagination = 0, $limit = 10){
		global $db, $sesion;
		try{
	...
	public function update($id_subimagenes, $name_subimagenes, $active_subimagenes, $photo_subimagenes, $id_servicios, $id_imagenes, $extra_subimagenes){
		global $db, $sesion;
		try{
			$sql = "UPDATE servicios_subimagenes SET name_subimagenes = :name_subimagenes, active_subimagenes = :active_subimagenes, photo_subimagenes = :photo_subimagenes, id_servicios = :id_servicios, id_imagenes = :id_imagenes, extra_subimagenes = :extra_subimagenes WHERE id_subimagenes = :id_subimagenes";
			$stmt = $db->prepare($sql);
	...
	public function add($name_subimagenes, $active_subimagenes, $photo_subimagenes, $id_servicios, $id_imagenes, $extra_subimagenes){
		global $db, $sesion;
		try{

			$sql = "INSERT INTO servicios_subimagenes (name_subimagenes, active_subimagenes, photo_subimagenes, id_servicios, id_imagenes, extra_subimagenes) VALUES(:name_subimagenes, :active_subimagenes, :photo_subimagenes, :id_servicios, :id_imagenes, :extra_subimagenes)";
			$stmt = $db->prepare($sql);
			$stmt->bindParam(':name_subimagenes', $name_subimagenes, PDO::PARAM_STR);
			$stmt->bindParam(':active_subimagenes', $active_subimagenes, PDO::PARAM_STR);
			$stmt->bindParam(':photo_subimagenes', $photo_subimagenes, PDO::PARAM_STR);
	...
	public function orden($id_subimagenes, $orden_subimagenes){
		global $db;
		try{
			$sql = "UPDATE servicios_subimagenes SET orden_subimagenes = :orden_subimagenes WHERE id_subimagenes = :id_subimagenes";
			$stmt = $db->prepare($sql);
			$stmt->bindParam(':id_subimagenes', $id_subimagenes, PDO::PARAM_STR);
	...
	public function delete($id_subimagenes){
		...
		$sql = "UPDATE servicios_subimagenes SET eliminado_subimagenes = :eliminado_subimagenes  WHERE id_subimagenes = :id_subimagenes";
		$stmt = $db->prepare($sql);
		$stmt->bindParam(':id_subimagenes', $id_subimagenes, PDO::PARAM_STR);
...
$servicios_subimagenes = new servicios_subimagenes();