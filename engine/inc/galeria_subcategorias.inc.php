...
class galeria_subcategorias {
	...
	public function edit($id_subcategorias){
		global $db, $sesion;
		try{
			$sql= "SELECT * FROM galeria_subcategorias WHERE id_subcategorias=:id_subcategorias AND eliminado_subcategorias = 0 ";
			$sql = $db->prepare($sql);
			...
			if($sql->rowCount() > 0){
				while($row = $sql->fetchObject()) {
					...
					$dir = _HOSTDIR_."/uploads/galeria/categorias/big/".$row->photo_subcategorias;
					$dir2 = _HOSTDIR_."/uploads/galeria/categorias/small/".$row->photo_subcategorias;
					if (file_exists($dir) && file_exists($dir2) && $row->photo_subcategorias != "") {
						$this->photo_subcategorias=_HOST_."/uploads/galeria/categorias/small/".$row->photo_subcategorias;
					}else{
	...
	public function view($seo_subcategorias){
		global $db, $sesion;
		try{
			$sql= "SELECT * FROM galeria_subcategorias WHERE seo_subcategorias=:seo_subcategorias AND eliminado_subcategorias = 0 ";
			$sql = $db->prepare($sql);
	...
	public function select($id_subcategorias = null, $id_categorias = -1){
		...
		try{
			$data = '';
			$sql = " SELECT * FROM galeria_subcategorias WHERE eliminado_subcategorias = 0 ";
			if ($id_categorias >= 0) {
	...
	public function data(){
		...
		try{
			$data = array();
			$sql= "SELECT * FROM galeria_subcategorias WHERE active_subcategorias = '1' AND eliminado_subcategorias = 0 ORDER BY orden_subcategorias ASC, name_subcategorias ASC ";
			$sql = $db->prepare($sql);
			$sql->execute();
			if($sql->rowCount() > 0){
				while($row = $sql->fetchObject()) {
					...
					if (file_exists($dir)  && $row->photo_subcategorias != "") {
						$json['photo'] =_HOST_."/uploads/galeria/categorias/big/".$row->photo_subcategorias;
					}else{
					...
					if (file_exists($dir2)  && $row->photo_subcategorias != "") {
						$json['photo_small'] =_HOST_."/uploads/galeria/categorias/small/".$row->photo_subcategorias;
					}else{
	...
	public function update($id_subcategorias, $name_subcategorias, $seo_subcategorias, $active_subcategorias, $photo_subcategorias, $id_categorias, $extra_subcategorias){
		global $db, $sesion;
		try{
			$sql = "UPDATE galeria_subcategorias SET name_subcategorias = :name_subcategorias, seo_subcategorias = :seo_subcategorias, active_subcategorias = :active_subcategorias, photo_subcategorias = :photo_subcategorias, id_categorias = :id_categorias, extra_subcategorias = :extra_subcategorias WHERE id_subcategorias = :id_subcategorias";
			$stmt = $db->prepare($sql);
	...
	public function add($name_subcategorias, $seo_subcategorias, $active_subcategorias, $photo_subcategorias, $id_categorias, $extra_subcategorias){
		global $db, $sesion;
		try{
			$sql= "SELECT * FROM galeria_subcategorias WHERE name_subcategorias=:name_subcategorias AND eliminado_subcategorias = 0 ";
			$stmt = $db->prepare($sql);
			$stmt->execute(array(":name_subcategorias"=>$name_subcategorias));
			if($stmt->rowCount() > 0){
				return false;
			}else{
				$sql = "INSERT INTO galeria_subcategorias (name_subcategorias, seo_subcategorias, active_subcategorias, photo_subcategorias, id_categorias, extra_subcategorias) VALUES(:name_subcategorias, :seo_subcategorias, :active_subcategorias, :photo_subcategorias, :id_categorias, :extra_subcategorias)";
				$stmt = $db->prepare($sql);
				$stmt->bindParam(':name_subcategorias', $name_subcategorias, PDO::PARAM_STR);
				$stmt->bindParam(':seo_subcategorias', $seo_subcategorias, PDO::PARAM_STR);
				$stmt->bindParam(':active_subcategorias', $active_subcategorias, PDO::PARAM_STR);
	...
	public function orden($id_subcategorias, $orden_subcategorias){
		global $db;
		try{
			$sql = "UPDATE galeria_subcategorias SET orden_subcategorias = :orden_subcategorias WHERE id_subcategorias = :id_subcategorias";
			$stmt = $db->prepare($sql);
			$stmt->bindParam(':id_subcategorias', $id_subcategorias, PDO::PARAM_STR);
	...
	public function delete($id_subcategorias){
		...
		$sql = "UPDATE galeria_subcategorias SET eliminado_subcategorias = :eliminado_subcategorias  WHERE id_subcategorias = :id_subcategorias";
		$stmt = $db->prepare($sql);
		$stmt->bindParam(':id_subcategorias', $id_subcategorias, PDO::PARAM_STR);
...
$galeria_subcategorias = new galeria_subcategorias();