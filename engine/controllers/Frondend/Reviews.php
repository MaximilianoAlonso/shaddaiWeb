...
class Reviews extends App\Controllers{
	...
	public function __invoke(Request $request, Response $response, $args){
		...
		$args['nav']['reviews'] = 'active';

		$response = $this->ci->view->render($response, 'frondend/'.$this->config['frondend'].'/reviews.twig', ['args' => $args, 'internas' => $internas, 'slider' => $slider]);
		return $response;
	}
