...
class NotFound extends \Slim\Handlers\NotFound
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        $this->logger->info("Not Allowed (404): {$request->getMethod()} {$path} IP {$this->ip} Analytics {$this->analytics}");
        ...
        */
        ...
        $response = $this->view->render($response->withStatus(404), 'errors/404.twig', ['path' => $path]);
		return $response;
    }
